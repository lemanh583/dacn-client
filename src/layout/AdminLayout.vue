      ...
      >
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/admin/users">
            ...
            <span style="margin-left: 10px">Danh sách người dùng</span>
          </router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/admin/posts">
            ...
            <span style="margin-left: 15px">Danh sách bài viết</span>
          </router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/admin/categories">
            ...
            <span style="margin-left: 10px">Danh sách thể loại</span>
          </router-link>
        </li>
